...
Patch3: modperf_su_php0.7.2_2011_07_20.patch
BuildRoot: %{_tmppath}/%{name}-%{version}-%{release}-root

BuildRequires: httpd-devel >= 2.0, gcc-c++, automake, autoconf, libtool
...
%changelog
* Mon Jul 01 2013 Alexey Berezhok <alexey_com@ukr.net> - 0.7.1-1.1
- Added mod_performance patch
